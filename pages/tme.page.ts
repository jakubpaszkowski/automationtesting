...
export class LoginPage {
    ...
    loginInput: Locator;    passwordInput: Locator;
    ...
    this.loginInput = this.page.getByRole('dialog').locator('input[name="f_login"]')
    this.passwordInput = this.page.getByRole('dialog').locator('input[name="f_password"]');
    this.loginButtonToAccesLogin = this.page.getByLabel('Zaloguj się');
    this.loginButton = this.page.getByRole('dialog').getByRole('button', { name: 'Zaloguj się' });
